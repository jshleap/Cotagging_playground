...
python /Users/jshleap/my_gits/Cottagging_playground/qtraitsimulation.py -p EUR -m $1 -b 0.66 -P ~/Programs/plink_mac/plink -t 8 -M 3000 -B ../EUR10K_5K

python /Users/jshleap/my_gits/Cottagging_playground/qtraitsimulation.py -p AFR -m $1 -b 0.66 -P ~/Programs/plink_mac/plink -t 8 -M 3000 -B ../AFR10K_5K --causal_eff EUR.full
