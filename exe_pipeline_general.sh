...
python $bins/qtraitsimulation.py -p EUR -m $1 -b 0.66 -P $plink -t 1 -M 3000 -B $path_to_bed/EUR10K_5K -2 $path_to_bed/AFR10K_5K

python $bins/qtraitsimulation.py -p AFR -m $1 -b 0.66 -P $plink -t 1 -M 3000 -B $path_to_bed/AFR10K_5K -2  $path_to_bed/EUR10K_5K  --causal_eff EUR.full
...
python $bins/ranumo.py -p Null -g EUR_gwas.assoc.linear -b $path_to_bed/AFR10K_5K -R EUR_test -f AFR.pheno -i EUR10K_5K_test.pheno -P $plink -c $path_to_bed/Cotagging10K_5K_taggingscores.tsv -s 1 -l EUR AFR -r EURppt.results -t AFRppt.results -H 0.66 -F 0.1 -q pdf -T 1 

python $bins/prankcster.py -p prancster -b EUR_test -c $path_to_bed/AFR10K_5K -L EUR AFR -T AFRppt.results -r EURppt.results -R Null_merged.tsv -d $path_to_bed/Cotagging10K_5K_taggingscores.tsv -s EUR_gwas.assoc.linear -f AFR.pheno -t 1 -P $plink -E 1 -S 0.1 -g $2 -F 0.1 -H 0.66 -Q Null.qrange -C "$3"
